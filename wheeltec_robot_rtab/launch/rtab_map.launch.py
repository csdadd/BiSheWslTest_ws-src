...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('odom_frame_id',  default_value='odom_combined',                   description='If set, TF is used to get odometry instead of the topic.'),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/odom_combined',  description='Odometry topic name.'),
